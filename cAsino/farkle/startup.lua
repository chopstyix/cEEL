...
function Player:drawScreen()
    ...
    screen:drawSurface(drawButton("Roll",colors.white),20,2)
    screen:drawSurface(drawButton("Skip",colors.white),40,2)
    screen:drawSurface(drawButton("Quit",colors.white),60,2)
    screen:output()
end
